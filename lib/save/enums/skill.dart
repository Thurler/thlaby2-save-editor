...
enum CommonSkill implements Skill {
  ...
  frontlineGuard(0, 0, 'Frontline Guard'),
  initiative(0, 0, 'Initiative'),
  absoluteDefensiveLine(0, 0, 'Absolute Defensive Line'),
  efficientConcentration(0, 0, 'Efficient Concentration'),
  monkMastery(0, 0, 'Monk Mastery'),
  bodyRevitalization(0, 0, 'Body Revitalization'),
  fastDash(0, 0, 'Fast Dash'),
  dexterityTraining(0, 0, 'Dexterity Training'),
  areaNormalAttack(0, 0, 'Area Normal Attack'),
  warriorMastery(0, 0, 'Warrior Mastery'),
  tensionUp(0, 0, 'Tension Up'),
  fastAttack(0, 0, 'Fast Attack'),
  enhancedNormalAttack(0, 0, 'Enhanced Normal Attack'),
  mindBodyOne(0, 0, 'Mind and Body as One'),
  enhancedRowAttack(0, 0, 'Enhanced Row Attack'),
  sorcererMastery(0, 0, 'Sorcerer Mastery'),
  magicBeating(0, 0, 'Magic Beating'),
  mindAssault(0, 0, 'Mind Assault'),
  healerMastery(0, 0, 'Healer Mastery'),
  efficientTreatment(0, 0, 'Efficient Treatment'),
  highLevelTreatment(0, 0, 'High-Level Treatment'),
  emergencyTreatment(0, 0, 'Emergency Treatment'),
  devotedCare(0, 0, 'Devoted Care'),
  enhancerMastery(0, 0, 'Enhancer Mastery'),
  heartCompassion(0, 0, 'Heart of Compassion'),
  heartPrayers(0, 0, 'Heart of Prayers'),
  enhancedBuffing(0, 0, 'Enhanced Buffing'),
  hexerMastery(0, 0, 'Hexer Mastery'),
  enhancedHexes(0, 0, 'Enhanced Hexes'),
  hexerDefense(0, 0, "Hexer's Defense"),
  hexerConversion(0, 0, "Hexer's Conversion"),
  toxicologistMastery(0, 0, 'Toxicologist Mastery'),
  enhancedToxins(0, 0, 'Enhanced Toxins'),
  toxicDefense(0, 0, 'Toxic Defense'),
  toxinConversion(0, 0, 'Toxin Conversion'),
  magicianMastery(0, 0, 'Magician Mastery'),
  magicSufficiency(0, 0, 'Magic Sufficiency'),
  magicConservation(0, 0, 'Magic Conservation'),
  entrustedWill(0, 0, 'Entrusted Will'),
  herbalistMastery(0, 0, 'Herbalist Mastery'),
  medicinalFragrance(0, 0, 'Medicinal Fragrance'),
  morningDewHerbs(0, 0, 'Morning Dew Herbs'),
  strategistMastery(0, 0, 'Strategist Mastery'),
  inspirationalPlan(0, 0, 'Inspirational Plan'),
  furiousScheme(0, 0, 'Furious Scheme'),
  ironcladStrategy(0, 0, 'Ironclad Strategy'),
  raidManeuver(0, 0, 'Raid Maneuver'),
  gamblerMastery(0, 0, 'Gambler Mastery'),
  highStakes(0, 0, 'High Stakes'),
  allOrNothing(0, 0, 'All or Nothing'),
  divaMastery(0, 0, 'Diva Mastery'),
  songDelight(0, 0, 'Song of Delight'),
  silentMelody(0, 0, 'Silent Melody'),
  melodyFortune(0, 0, 'Melody of Fortune'),
  transcendentMastery(0, 0, 'Transcendent Mastery'),
  bodyReinforcement(0, 0, 'Body Reinforcement'),
  enhancedCombat(0, 0, 'Enhanced Combat'),
  swordmasterMastery(0, 0, 'Swordmaster Mastery'),
  asuraStance(0, 0, "Asura's Stance"),
  archmageMastery(0, 0, 'Archmage Mastery'),
  welcomeSpirituality(0, 0, 'Welcome to Spirituality'),
  appraiserMastery(0, 0, 'Appraiser Mastery'),
  dailyToils(0, 0, 'Daily Toils'),
  basicsBusiness(0, 0, 'Basics of Business'),
  aestheticSense(0, 0, 'Aesthetic Sense'),
  killBonusExp(0, 0, 'Kill Bonus - Experience'),
  killBonusMoney(0, 0, 'Kill Bonus - Money'),
  killBonusDrops(0, 0, 'Kill Bonus - Drops'),
  elementalistMastery(0, 0, 'Elementalist Mastery'),
  elementMemoryDefense(0, 0, 'Element Memory Defense'),
  elementAreaDefense(0, 0, 'Element Area Defense'),
  ninjaMastery(0, 0, 'Ninja Mastery'),
  armorPierce(0, 0, 'Armor Pierce'),
  ironOxideCaltrops(0, 0, 'Iron Oxide Caltrops'),
  lacqueredSpikedKnuckles(0, 0, 'Lacquered Spiked Knuckles'),
  ruffianKnowledge(0, 0, "Ruffian's Knowledge"),
  oracleMastery(0, 0, 'Oracle Mastery'),
  fakeOracleMachine(0, 0, 'Fake Oracle Machine'),
  ecstaticalCeremony(0, 0, 'Ecstatical Ceremony'),
  prophetPrediction(0, 0, "Prophet's Prediction"),
  heavenlyRevelation(0, 0, 'Heavenly Revelation'),
  worldLinkingIntuition(0, 0, 'World-Linking Intuition'),
  holyBlessing(0, 0, 'Holy Blessing'),
  oneOfThreeTreasures(0, 0, 'One of the Three Treasures'),
  ninigiSwordSheath(0, 0, "Ninigi's Sword Sheath"),
  powerSupremeRuler(0, 0, 'Power of the Supreme Ruler'),
  threeLegendarySwords(0, 0, 'Three Legendary Swords'),
  dragonGodPower(0, 0, "Dragon God's Power"),
  elementalProtection(0, 0, 'Elemental Protection'),
  flameBlessing(0, 0, 'Flame Blessing'),
  woodBlessing(0, 0, 'Wood Blessing'),
  waterBlessing(0, 0, 'Water Blessing'),
  earthBlessing(0, 0, 'Earth Blessing'),
  metalBlessing(0, 0, 'Metal Blessing'),
  winnerTitle(0, 0, '*WINNER* Title'),
  autoRoller(0, 0, 'Auto Roller'),
  elementalImmunity(0, 0, 'Elemental Immunity'),
  magicArmor(0, 0, 'Magic Armor');
