...
enum CommonSkill implements Skill {
  ...
  guardianMastery(0, 0, 'Guardian Mastery'),
  frontlineGuard(1, 10, 'Frontline Guard'),
  initiative(1, 10, 'Initiative'),
  absoluteDefensiveLine(1, 10, 'Absolute Defensive Line'),
  efficientConcentration(2, 5, 'Efficient Concentration'),
  monkMastery(0, 0, 'Monk Mastery'),
  bodyRevitalization(1, 10, 'Body Revitalization'),
  fastDash(1, 10, 'Fast Dash'),
  dexterityTraining(1, 10, 'Dexterity Training'),
  areaNormalAttack(1, 10, 'Area Normal Attack'),
  warriorMastery(0, 0, 'Warrior Mastery'),
  tensionUp(2, 5, 'Tension Up'),
  fastAttack(2, 5, 'Fast Attack'),
  enhancedNormalAttack(1, 8, 'Enhanced Normal Attack'),
  mindBodyOne(2, 5, 'Mind and Body as One'),
  enhancedRowAttack(3, 4, 'Enhanced Row Attack'),
  sorcererMastery(0, 0, 'Sorcerer Mastery'),
  magicBeating(2, 5, 'Magic Beating'),
  mindAssault(2, 5, 'Mind Assault'),
  healerMastery(0, 0, 'Healer Mastery'),
  efficientTreatment(3, 4, 'Efficient Treatment'),
  highLevelTreatment(5, 3, 'High-Level Treatment'),
  emergencyTreatment(3, 3, 'Emergency Treatment'),
  devotedCare(1, 8, 'Devoted Care'),
  enhancerMastery(0, 0, 'Enhancer Mastery'),
  heartCompassion(4, 3, 'Heart of Compassion'),
  heartPrayers(2, 6, 'Heart of Prayers'),
  enhancedBuffing(2, 6, 'Enhanced Buffing'),
  hexerMastery(0, 0, 'Hexer Mastery'),
  enhancedHexes(2, 6, 'Enhanced Hexes'),
  hexerDefense(2, 5, "Hexer's Defense"),
  hexerConversion(1, 10, "Hexer's Conversion"),
  toxicologistMastery(0, 0, 'Toxicologist Mastery'),
  enhancedToxins(2, 6, 'Enhanced Toxins'),
  toxicDefense(2, 5, 'Toxic Defense'),
  toxinConversion(1, 10, 'Toxin Conversion'),
  magicianMastery(0, 0, 'Magician Mastery'),
  magicSufficiency(5, 2, 'Magic Sufficiency'),
  magicConservation(1, 10, 'Magic Conservation'),
  entrustedWill(2, 5, 'Entrusted Will'),
  herbalistMastery(0, 0, 'Herbalist Mastery'),
  medicinalFragrance(1, 8, 'Medicinal Fragrance'),
  morningDewHerbs(1, 8, 'Morning Dew Herbs'),
  strategistMastery(0, 0, 'Strategist Mastery'),
  inspirationalPlan(1, 10, 'Inspirational Plan'),
  furiousScheme(10, 1, 'Furious Scheme'),
  ironcladStrategy(10, 1, 'Ironclad Strategy'),
  raidManeuver(1, 10, 'Raid Maneuver'),
  gamblerMastery(0, 0, 'Gambler Mastery'),
  highStakes(2, 8, 'High Stakes'),
  allOrNothing(2, 8, 'All or Nothing'),
  divaMastery(0, 0, 'Diva Mastery'),
  songDelight(2, 5, 'Song of Delight'),
  silentMelody(3, 4, 'Silent Melody'),
  melodyFortune(1, 10, 'Melody of Fortune'),
  transcendentMastery(0, 0, 'Transcendent Mastery'),
  bodyReinforcement(10, 3, 'Body Reinforcement'),
  enhancedCombat(2, 8, 'Enhanced Combat'),
  swordmasterMastery(0, 0, 'Swordmaster Mastery'),
  asuraStance(1, 25, "Asura's Stance"),
  archmageMastery(0, 0, 'Archmage Mastery'),
  welcomeSpirituality(1, 25, 'Welcome to Spirituality'),
  appraiserMastery(0, 0, 'Appraiser Mastery'),
  dailyToils(3, 4, 'Daily Toils'),
  basicsBusiness(3, 4, 'Basics of Business'),
  aestheticSense(3, 4, 'Aesthetic Sense'),
  killBonusExp(1, 10, 'Kill Bonus - Experience'),
  killBonusMoney(1, 10, 'Kill Bonus - Money'),
  killBonusDrops(1, 10, 'Kill Bonus - Drops'),
  elementalistMastery(0, 0, 'Elementalist Mastery'),
  elementMemoryDefense(1, 15, 'Element Memory Defense'),
  elementAreaDefense(1, 20, 'Element Area Defense'),
  ninjaMastery(0, 0, 'Ninja Mastery'),
  armorPierce(1, 20, 'Armor Pierce'),
  ironOxideCaltrops(1, 10, 'Iron Oxide Caltrops'),
  lacqueredSpikedKnuckles(1, 10, 'Lacquered Spiked Knuckles'),
  ruffianKnowledge(1, 10, "Ruffian's Knowledge"),
  oracleMastery(0, 0, 'Oracle Mastery'),
  fakeOracleMachine(1, 10, 'Fake Oracle Machine'),
  ecstaticalCeremony(1, 25, 'Ecstatical Ceremony'),
  prophetPrediction(1, 10, "Prophet's Prediction"),
  heavenlyRevelation(1, 10, 'Heavenly Revelation'),
  worldLinkingIntuition(1, 10, 'World-Linking Intuition'),
  holyBlessing(0, 0, 'Holy Blessing'),
  oneOfThreeTreasures(1, 25, 'One of the Three Treasures'),
  ninigiSwordSheath(1, 25, "Ninigi's Sword Sheath"),
  powerSupremeRuler(1, 25, 'Power of the Supreme Ruler'),
  threeLegendarySwords(1, 25, 'Three Legendary Swords'),
  dragonGodPower(0, 0, "Dragon God's Power"),
  elementalProtection(20, 3, 'Elemental Protection'),
  flameBlessing(1, 25, 'Flame Blessing'),
  woodBlessing(1, 25, 'Wood Blessing'),
  waterBlessing(1, 25, 'Water Blessing'),
  earthBlessing(1, 25, 'Earth Blessing'),
  metalBlessing(1, 25, 'Metal Blessing'),
  winnerTitle(0, 0, '*WINNER* Title'),
  autoRoller(5, 10, 'Auto Roller'),
  elementalImmunity(10, 10, 'Elemental Immunity'),
  magicArmor(10, 10, 'Magic Armor');
...
enum SubclassSpell implements Skill {
  ...
  ironMountainCharge(3, 'Iron Mountain Charge'),
  severingFlash(3, 'Severing Flash'),
  explosiveFlameSword(3, 'Explosive Flame Sword'),
  penetrator(3, 'Penetrator'),
  aspirationSurge(3, 'Aspiration Surge'),
  prayerRecovery(3, 'Prayer of Recovery'),
  prayerGoodHealth(3, 'Prayer of Good Health'),
  artBattlemage(3, 'Art of the Battlemage'),
  ouncePrevention(3, 'An Ounce of Prevention'),
  hexCrimson(3, 'Hex -Crimson Curse-'),
  hexDark(3, 'Hex -Dark Curse-'),
  hexWhite(3, 'Hex -White Curse-'),
  poisonousIncense(3, 'Poisonous Incense'),
  paralyzingIncense(3, 'Paralyzing Incense'),
  numbingIncense(3, 'Numbing Incense'),
  deathlyIncense(3, 'Deathly Incense'),
  magicTransfer(5, 'Magic Transfer'),
  magicCircuit(3, 'Magic Circuit'),
  placeboEffect(3, 'Placebo Effect'),
  incenseTreatment(5, 'Incense Treatment'),
  herbAwakening(3, 'Herb of Awakening'),
  rhythmicDance(3, 'Rhythmic Dance'),
  danceCochlea(3, 'Dance of the Cochlea'),
  moonShadowFlash(8, 'Moon Shadow Flash'),
  samidareSlash(8, 'Samidare Slash'),
  swordmasterStance(8, "Swordmaster's Stance"),
  southernCross(8, 'Southern Cross'),
  execution(8, 'Execution'),
  archmageChant(8, "Archmage's Chant"),
  enchantSpinel(8, 'Enchant - Spinel'),
  enchantLazurite(8, 'Enchant - Lazurite'),
  enchantPyrope(8, 'Enchant - Pyrope'),
  enchantFluorite(8, 'Enchant - Fluorite'),
  assassinationSword(8, 'Assassination Sword'),
  swiftSpeed(8, 'Swift Speed'),
  oracleTalisman(8, "Oracle's Talisman"),
  ameMurakumoSlash(10, 'Ame-no-Murakumo Slash'),
  startHeavenlyDemise(10, 'Start of Heavenly Demise'),
  worldShakingRule(10, 'World-Shaking Rule'),
  dragonGodSigh(15, "Dragon God's Sigh"),
  vorpalBlade(15, 'Vorpal Blade'),
  manaStorm(15, 'Mana Storm'),
  swordLight(15, 'Sword of Light'),
  staffDestruction(15, 'Staff of *Destruction*');
