...
enum Spell implements Skill {
  ...
  illDive(5, 5, 'Ill-Starred Dive'),
  poisonousDance(5, 5, "Poisonous Moth's Dark Dance"),
  midnightChorus(5, 5, 'Midnight Chorus Master'),
  ...
  catWalk(5, 5, "Cat's Walk"),
  vengefulSpirit(5, 5, 'Vengeful Cannibal Spirit'),
  hellNeedleHill(5, 5, "Former Hell's Needle Hill"),
  blazingWheel(5, 5, 'Blazing Wheel'),
