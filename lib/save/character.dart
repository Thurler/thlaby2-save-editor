...
enum Character {
  ...
  patchouli(
    ...
    <Skill>[
      CommonSkill.sdmResidents, CommonSkill.grandIncantation,
      CommonSkill.girlKnowledgeShade, CommonSkill.passivePhilosopher,
      CommonSkill.rapidCharge, CommonSkill.unmovingGreatLibrary,
      CommonSkill.infiniteBookCollection, CommonSkill.asthmaMedicine,
      CommonSkill.speedyIncantation, CommonSkill.proofKinship,
    ],
    <Skill>[
  ...
  eirin(
    ...
    <Skill>[
      CommonSkill.residentsEientei, CommonSkill.peopleMoon,
      CommonSkill.healingLimitBreak, CommonSkill.coolingDown,
      CommonSkill.pharmacistMixing, CommonSkill.thousandExile,
      CommonSkill.specialEndurance, CommonSkill.lunarSageWisdom,
      CommonSkill.poisonMixing, CommonSkill.proofKinship,
    ],
    <Skill>[
  ...
  reisen(
    ...
    <Skill>[
      CommonSkill.residentsEientei, CommonSkill.peopleMoon,
      CommonSkill.finalBlow, CommonSkill.mindModulation,
      CommonSkill.wavelengthInsanity, CommonSkill.intenseVertigo,
      CommonSkill.vaporousRedEyes, CommonSkill.enhancedMindModulation,
      CommonSkill.grandVertigo, CommonSkill.proofKinship,
    ],
    <Skill>[
  ...
  sanae(
    ...
    <Skill>[
      CommonSkill.believersMoriya, CommonSkill.expansionConsciousness,
      CommonSkill.lastWish, CommonSkill.moriyaProtection,
      CommonSkill.powerLivingGod, CommonSkill.youkaiBuster,
      CommonSkill.miracleFafrotskies, CommonSkill.sacrificalMaiden,
      CommonSkill.hisoutenGuard, CommonSkill.proofKinship,
    ],
    <Skill>[
  ...
  iku(
    ...
    <Skill>[
      CommonSkill.hisoutenGuard, CommonSkill.magicCounter,
      CommonSkill.hagoromoSky, CommonSkill.flexibility,
      CommonSkill.suppleHagoromo, CommonSkill.heavenlyBlow,
      CommonSkill.lightningFish, CommonSkill.magicCounterPlus,
      CommonSkill.thunderAbtruseClouds, CommonSkill.pearlClawedDragon,
    ],
    <Skill>[
  ...
  suika(
    ...
    <Skill>[
      CommonSkill.ibukiGourd, CommonSkill.freeSpiritedOni,
      CommonSkill.fogLabyrinth, CommonSkill.artOniBinding,
      CommonSkill.encounterFoe, CommonSkill.earthSpiritDense,
      CommonSkill.pandemonicSprinkle, CommonSkill.fourDevaOoe,
    ],
    <Skill>[
  ...
  ran(
    ...
    <TomeStat>[TomeStat.mp, TomeStat.mag, TomeStat.spd],
    <Skill>[
      CommonSkill.yakumoClan, CommonSkill.abilityShikigamis,
      CommonSkill.superFastHardArithmetic, CommonSkill.expansionConsciousness,
      CommonSkill.coolingDown, CommonSkill.shikigamiDefense,
      CommonSkill.hermitFoxThoughts, CommonSkill.kokkuriContract,
      CommonSkill.friedTofuPower, CommonSkill.proofKinship,
    ],
    <Skill>[
  ...
  yuyuko(
    ...
    <Skill>[
      Spell.dreamButterfly, Spell.swallowtailLance,
      Spell.ghastlyDream, Spell.flawlessNirvana,
    ],
    <Skill>[],
  ),
  yuuka(
